...
**Status:** ✅ v6 – Mehrseitiges Layout mit festen Headern  
**Kürzel:** MZ

## Layout-Übersicht

Multipage-Layout mit wiederkehrenden Headern ("Liste 1", "Liste 2"). Start beginnt bei **B5**, Seitenlänge 25 Zeilen, Offset 30 Zeilen.

| Seite | Formel-Zelle | Daten-Bereich | Zeilen | Kapazität | Offset |
|-------|--------------|---------------|--------|-----------|--------|
| 1 | **B5** | B5:E29 | 1-25 | 25 | 0 |
| 2 | **B35** | B35:E59 | 26-50 | 25 | 30 |
| 3 | **B65** | B65:E89 | 51-75 | 25 | 60 |
| 4 | **B95** | B95:E119 | 76-100 | 25 | 90 |
...
|--------|------|--------|
| A | Lfd. Nr | *separat* |
| B | Name, Vorname | Index 13 + 12 |
| C | PLZ & Wohnort | Index 16 + 17 (Format: "PLZ Ort") |
| D | Geburtsjahr | Index 14 (yyyy) |
...
| Key | Event-Typ |
|-----|-----------|
| `Kreisfreie Stadt Mainz_Soziale_Bildung` | Soziale_Bildung |
| `Kreisfreie Stadt Mainz_Schulung_Ehrenamtlicher_Mitarbeitenden` | Schulung |
| `Kreisfreie Stadt Mainz_Politische_Jugendbildung` | Politische_Jugendbildung |

---

## Seite 1 – Zelle B5 (Zeilen 1-25)
...
=LET(
  ...
  start_idx; IF(page=1; 1; (page-1)*page_size + 1);
  end_idx; page * page_size;
  
  ziel_landkreis; "Kreisfreie Stadt Mainz";
            ...
            IF(AND(page = 1; cnt_final < min_tn); IF(debug_mode; "⚠️ Min TN (" & min_tn & ") nicht erreicht. Aktuell: " & cnt_final; "");
              IF(start_idx > cnt_final; "";
                LET(
                  ...
                  HSTACK(col_name; col_plz_ort; col_jahr; col_tage)
                )
              )
            )
          )
...
## Seite 2 – Zelle B35 (Zeilen 26-50)
...
## Seite 3 – Zelle B65 (Zeilen 51-75)
...
## Seite 4 – Zelle B95 (Zeilen 76-100)
