# Formel für Trier-Saarburg V6

**Status:** ✅ v6 – 2 getrennte Bereiche (MA, TN)  
**Kürzel:** TR-SAB

## Layout-Übersicht

Die Liste hat **2 separate Bereiche** nach Funktion:
...
|--------|------|----------------|
| A | Lfd. Nr. | *separat* |
| B | Vor- und Zuname | `Name` & " " & `Vorname` |
| C | PLZ + Wohnort | `PLZ` & ", " & `Wohnort` |
| D | Geburtsjahr | `YEAR(Geburtsdatum)` |
| E | Veranstaltungstage | `Anwesenheit` |
| F | Unterschrift | leer |
...
| Key | Event-Typ |
|-----|-----------|
| `Landkreis Trier-Saarburg_Soziale_Bildung` | Soziale_Bildung |
| `Landkreis Trier-Saarburg_Schulung_Ehrenamtlicher_Mitarbeitenden` | Schulung |
| `Landkreis Trier-Saarburg_Politische_Jugendbildung` | Politische_Jugendbildung |

---

## Bereich 1: MA – Zelle B3 (max 12 Zeilen)
...
=LET(
  ...
  ziel_landkreis; "Landkreis Trier-Saarburg";
...
## Bereich 2: TN – Zelle B15 (max 150+ Zeilen)
